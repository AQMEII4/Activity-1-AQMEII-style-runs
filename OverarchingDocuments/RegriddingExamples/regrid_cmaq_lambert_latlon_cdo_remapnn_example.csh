...
set OUTFILE = CMAQ_O3_Example_LATLON_CDO_REMAPNN_12US1_20160101.nc

set OUTFILE_IOAPI = CMAQ_O3_Example_LATLON_CDO_IOAPI_REMAPNN_12US1_20160101.nc
...
setenv REMAP_EXTRAPOLATE OFF

time ${EXEC1} -m -9.999E+36 \
              remapnn,/home/chogrefe/work1/aqmeii4/scripts/grid_file_aqmeii4_latlon_565_281_lonlat.txt \
              -setgrid,/home/chogrefe/work1/aqmeii4/scripts/grid_file_12us1_459_299.txt \
	      ${INDIR}/${INFILE} \
	      ${OUTDIR}/${OUTFILE}

unsetenv REMAP_EXTRAPOLATE
